...
def load_train_test_data(data_set):
    ...
    train_file = os.path.join(ROOT_PATH, 'data', data_set, 'book_crossing_df_train.parquet')
    test_file = os.path.join(ROOT_PATH, 'data', data_set, 'book_crossing_df_test.parquet')
