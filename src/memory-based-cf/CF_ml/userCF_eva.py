...
predicted_ratings_file = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_mlTT\predicted_ratings_all_userCF.csv'
...
if errors:
    ...
    metrics_file_path = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_mlTT\metrics_value_userCF.txt'
