...
userCF_sim_file = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\ml-20mTT\5.ml_20m_user_sim.parquet'
user_sim = pd.read_parquet(userCF_sim_file)
#%%
# retrieve all the userId & movieId
ratings_train_file = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\ml-20mTT\2.ml_20m_df_train.parquet'
ratings = pd.read_parquet(ratings_train_file)
...
#%%
# Re-construct the user similarity matrix
...
#%%
# reverse the original itemId & use
...
output_file_path_complete_prediction = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_mlTT\predicted_ratings_all_userCF.csv'
...
output_file_path_recommendation = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_mlTT\user_recommendation_userCF.pkl'
