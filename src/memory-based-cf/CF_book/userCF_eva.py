...
predicted_ratings_file = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_bookTT\predicted_ratings_all_userCF.csv'
predicted_ratings_df = pd.read_csv(predicted_ratings_file, index_col=0)
# %%
# Load the test ratings file
ratings_file = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\book_crossingTT\3.book_crossing_df_test.parquet'
...
if errors:
    ...
    metrics_file_path = r'E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_bookTT\metrics_value_userCF.txt'
