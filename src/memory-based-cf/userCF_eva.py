...
# predictions_file_path = r"E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_ml\predicted_ratings_all_userCF.pkl"
predictions_file_path = r"/home/msds/cli034/DataMiningproject/CF_ml/predicted_ratings_all_userCF.pkl"
...
if average_error is not None:
    ...
    # with open(r"E:\AAASchoolLearning\StudyResource\GraduateNTU\ProjectSum\DataMiningproject\CF_ml\average_error_userCF.txt", 'w') as error_file:
    with open(r"/home/msds/cli034/DataMiningproject/CF_ml/average_error_userCF.txt", 'w') as error_file:
